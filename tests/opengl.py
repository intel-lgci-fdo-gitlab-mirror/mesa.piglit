...
with profile.test_list.group_manager(
    ...
    g(['glx-multithread-buffer-busy-tracking-bug'], run_concurrent=False)
...
with profile.test_list.group_manager(
    ...
    g(['gl-1.0-texgen'])
    g(['gl-1.0-texture-matrix-push-pop'])
...
with profile.test_list.group_manager(
    ...
    g(['arb_point_sprite-checkerboard_gles1'])
...
with profile.test_list.group_manager(
    ...
    g(['arb_fragment_program-recompile'], 'recompile')
...
with profile.test_list.group_manager(
    ...
    g(['arb_program_interface_query-compare-with-shader-subroutine'])
...
with profile.test_list.group_manager(
    ...
    g(['arb_vertex_program-get-limits-without-fp'])
    g(['vp-address-01'])
    g(['vp-address-02'])
    g(['vp-address-04'])
    g(['vp-bad-program'])
...
with profile.test_list.group_manager(
    ...
    for sample_count in MSAA_SAMPLE_COUNTS:
        g(['ext_framebuffer_multisample-turn-on-off', sample_count],
          'turn-on-off {}'.format(sample_count))
...
with profile.test_list.group_manager(
    ...
    g(['ext_gpu_shader4-vertexid-beginend'])
...
with profile.test_list.group_manager(
    ...
    g(['ext_image_dma_buf_import-sample_yuv', '-fmt=Y416'],
    ...
    g(['ext_image_dma_buf_import-export'])
    g(['ext_image_dma_buf_import-export-tex'])
    g(['ext_image_dma_buf_import-reimport-bug'])
    g(['ext_image_dma_buf_import-refcount-multithread'])
    g(['ext_image_dma_buf_import-render-rgb24'])
...
with profile.test_list.group_manager(
    ...
    g(['arb_texture_cube_map-unusual-order'])
    g(['cubemap'])
...
with profile.test_list.group_manager(
    ...
    g(['s3tc-targeted'])
    g(['s3tc-teximage'])
    g(['s3tc-teximage_gles2'])
    g(['s3tc-texsubimage'])
    g(['s3tc-texsubimage_gles2'])
...
with profile.test_list.group_manager(
    ...
    g(['arb_transform_feedback3-begin_end'])
...
with profile.test_list.group_manager(
    ...
    g(['ext_fog_coord-modes-half-float'])
...
with profile.test_list.group_manager(
    ...
    g(['draw-vertices-half-float_gles2'])
...
with profile.test_list.group_manager(
    ...
    g(['gl-3.3-vertex-attrib-pointer-type-size-match'], 'attrib-pointer-type-size-match')
...
with profile.test_list.group_manager(
    ...
    g(['arb_blend_func_extended-dual-src-blending-issue-1917'])
    ...
    g(['arb_blend_func_extended-dual-src-blending-issue-1917_gles3'])
...
with profile.test_list.group_manager(
    ...
    g(['oes_draw_elements_base_vertex-drawelements'])
...
with profile.test_list.group_manager(
    ...
    g(['arb_shader_draw_parameters-drawid-single-draw', 'restart'], 'drawid-single-draw-primitive-restart')
...
with profile.test_list.group_manager(
    ...
    #g(['ovr_multiview-fb_shader_mismatch_draw_errors', '0', '1'], 'fb_shader_mismatch_draw_errors_0_1')
    g(['ovr_multiview-fb_shader_mismatch_draw_errors', '0', '2'], 'fb_shader_mismatch_draw_errors_0_2')
    #g(['ovr_multiview-fb_shader_mismatch_draw_errors', '1', '0'], 'fb_shader_mismatch_draw_errors_1_0')
    g(['ovr_multiview-fb_shader_mismatch_draw_errors', '1', '1'], 'fb_shader_mismatch_draw_errors_1_1')
    g(['ovr_multiview-fb_shader_mismatch_draw_errors', '1', '2'], 'fb_shader_mismatch_draw_errors_1_2')
    g(['ovr_multiview-fb_shader_mismatch_draw_errors', '2', '0'], 'fb_shader_mismatch_draw_errors_2_0')
    g(['ovr_multiview-fb_shader_mismatch_draw_errors', '2', '1'], 'fb_shader_mismatch_draw_errors_2_1')
    g(['ovr_multiview-fb_shader_mismatch_draw_errors', '2', '2'], 'fb_shader_mismatch_draw_errors_2_2')
    g(['ovr_multiview-fb_shader_mismatch_draw_errors', '2', '3'], 'fb_shader_mismatch_draw_errors_2_3')
    g(['ovr_multiview-fb_shader_mismatch_draw_errors', '3', '2'], 'fb_shader_mismatch_draw_errors_3_2')
